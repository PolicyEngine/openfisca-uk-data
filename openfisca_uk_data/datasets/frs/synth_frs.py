...
DEFAULT_SYNTH_URL = "https://github.com/PolicyEngine/openfisca-uk-data/releases/download/synth-frs/synth_frs_2019.h5"
...
class SynthFRS:
    ...
    def save(data_file: str = DEFAULT_SYNTH_URL, year: int = 2019):
